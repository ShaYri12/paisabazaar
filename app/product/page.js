...
export default function Product() {
  ...
  return (
    <main className="flex md:flex-row flex-col md:h-screen overflow-y-auto">
      {/* Left Section */}
      <div
        className="lg:w-[43%] md:w-[47%] w-full px-[24px] py-[10px] md:h-screen overflow-y-auto"
        style={{
          background:
      ...
      {/* Right Section */}
      <div className="lg:w-[57%] md:w-[53%] w-full bg-white md:p-12 p-5 overflow-y-auto md:h-screen">
