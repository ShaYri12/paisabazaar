...
export default function InsurancePlan() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 flex items-center justify-center w-full">
          ...
          <>
            <div className="text-center mt-[36px]">
              <h1 className="text-[32px] font-[500] text-gray-900 mb-[16px]">
                ...
                <span className="text-[20px] text-gray-700 align-top">**</span>
              </h1>
            </div>
